...
- `scripts/cron/q_monitor_cron.sh` → `scripts/core/q_monitor.py`
  ...
  - **종목 선정 v2.1 — 풀 199종목 1분봉 직접 평가**
    ...
    - **2026-07-01**: 2사이클 0승 2패 (원익IPS 240810 -1.45% 손절 -61,824원 gross / 이오테크닉스 039030 -1.43% 손절 -55,896원 gross). 일일 **-3.13%** / Net -134,680원 / 누적 -14.06% → **-16.76% 심화**. **이오테크닉스 06-30·07-01 이틀 연속 손절** — 재매수 가드 영업일 한정 문제 반복 (금호타이어 06-25→06-26 사례 이후 재현). **17일 누적 (06-09~07-01): 17사이클 6승 12패 / 승률 33.3% / Net -413,122원** — 승률 37.5% → 33.3% 재하락, 백테스트 OOS(35.7%) 하회. 손절 종목 8종(+원익IPS)
    - **2026-07-02**: 4사이클 3승 1패 (위메이드 112040 09:42→09:48 **+2.98% 익절** 6분만 +123,840원 gross / 솔브레인 357780 10:04→10:16 **+2.43% 익절** 12분만 +100,800원 gross / HD현대일렉트릭 267260 11:04→11:17 -1.65% 손절 13분만 -68,080원 gross / 주성엔지니어링 036930 11:18→11:48 +0.11% 시간청산 30분 +4,369원 gross). 일일 **+3.02%** / Net +125,888원 / 누적 -16.76% → **-14.24% 회복**. 4사이클 모두 오전(09:42~11:48) 시그널로 발동, 오후 14:00 진입 마감까지 추가 시그널 0건. **일일 매매 한도 8회(진입 4 + 청산 4) 정확 소진** → 자연 종료. **18일 누적 (06-09~07-02): 21사이클 9승 13패 / 승률 40.9% / Net -287,234원** — 승률 33.3% → 40.9% 반등, 6/11 이후 최고 흑자일. 시드 대비 여전히 -14.24%로 심각. 손절 종목 9종(+HD현대일렉트릭)
    - **2026-07-03**: 1사이클 1승 0패 (삼성전기 009150 11:14→11:44 +0.80% 시간청산 30분 +30,226원 gross). 일일 **+0.52%** / Net +22,273원 / 누적 -14.24% → **-13.80% 소폭 회복**. **매치 발생 스캔 단 1건** (풀 199개 near-miss는 다수지만 임계 미달) — 어제 8회 한도 소진과 대조적으로 오늘은 시장 변동성 자체가 낮아 signal 희소. **19일 누적 (06-09~07-03): 22사이클 10승 13패 / 승률 43.5% / Net -264,961원** — 승률 33.3% → 40.9% → **43.5%** 3일 연속 상승, 백테스트 학습/검증(50%)까지 격차 6.5%p. 이틀 연속 흑자로 폐기 기준(누적 <0 + 승률 <45%) 중 승률은 여전히 경계선
    - **2026-07-04 ~ 07-22**: 13영업일 연속 매매 0건 (저변동성, 시그널 미발생). **⚠️ 07-03 이후 `portfolio_snapshots` 갱신도 정지** — 07-23~08-04 매매 스냅샷이 DB에 미기록 (이하 누적%는 net 역산). 별도 운영 점검 대상
    - **2026-07-23**: 1사이클 0승 1패 (한국카본 017960 11:19→11:24 -1.86% 손절 4분 14초만에 -79,947원 gross). 20영업일 만의 매매 재개가 손절로 시작. 일일 **-2.06%** / Net -88,804원 / 누적 -13.80% → **-15.57%**. **23사이클 10승 14패 / 승률 41.7%**
    - **2026-07-24**: 2사이클 1승 1패 (OCI홀딩스 010060 09:39→09:57 **+3.16% 익절** 17분만 +131,767원 gross / 현대로템 064350 13:43→13:48 -2.40% 손절 5분만 -100,334원 gross). 일일 **+0.33%** / Net +13,839원 / 누적 -15.57% → **-15.29%**. **25사이클 11승 15패 / 승률 42.3%**
    - **2026-07-29**: 3사이클 1승 2패 (한미약품 128940 09:46→09:48 -1.64% 손절 -69,186원 gross / GS건설 006360 09:50→09:53 -1.38% 손절 -57,171원 gross / 포스코DX 022100 11:18→11:48 +0.65% 시간청산 30분 +26,781원 gross). 일일 **-2.96%** / Net -125,520원 / 누적 -15.29% → **-17.80%**. **28사이클 12승 17패 / 승률 41.4%**
    - **2026-07-30**: 3사이클 0승 3패 (에스피지 058610 09:35→09:43 -1.69% 손절 -69,050원 gross / 금호타이어 073240 09:44→09:45 -2.00% 손절 1분 7초만에 -80,645원 gross / LG생활건강 051900 10:02→10:25 -1.60% 손절 -62,361원 gross). 일일 **-5.76%** (단일일 최악, 06-22 -3.92% 경신) / Net -236,868원 / 누적 -17.80% → **-22.54% 급락**. 금호타이어 06-25·06-26에 이어 3번째 손절. **31사이클 12승 20패 / 승률 37.5%**
    - **2026-07-31**: 1사이클 0승 1패 (HD현대마린엔진 071970 13:58→14:06 -2.16% 손절 -82,792원 gross). 14:00 마감 직전 마지막 시그널. 일일 **-2.34%** / Net -90,697원 / 누적 -22.54% → **-24.36%**. **32사이클 12승 21패 / 승률 36.4%**
    - **2026-08-04**: 1사이클 0승 1패 (에코프로머티 450080 13:55→13:56 -1.91% 손절 1분 11초만에 -72,162원 gross). 매수 1분 11초만에 손절 (false breakout 지속). 일일 **-2.11%** / Net -79,961원 / 누적 -24.36% → **-25.96%**. **33일 누적 (패치 후 06-09~08-04): 33사이클 12승 22패 / 승률 35.3% / Net -872,972원** — 07월 이후 급격 악화, 백테스트 OOS(35.7%)와 정확히 수렴. 07-02(8회 한도 소진 흑자) 외 손절 일변도, 손절 종목 다양(한국카본·현대로템·한미약품·GS건설·에스피지·금호타이어×3·LG생활건강·HD현대마린엔진·에코프로머티)으로 룰 구조적 문제 재확인. 사용자 장기 관찰 결정 유지
