      ...
      <table className="w-full text-sm whitespace-nowrap">
        <thead>
          <tr className="border-b border-white/5 text-gray-500 text-xs">
            ...
            <th className="text-right py-2.5 px-2 sm:px-4">현재가</th>
            <th className="text-right py-2.5 px-2 sm:px-4">등락률</th>
            <th className="text-right py-2.5 px-2 sm:px-4 hidden sm:table-cell">보유</th>
          </tr>
        </thead>
        <tbody>
          {rows.map((s) => (
