...
- **리밸런싱**: 주 1회 수요일 정규 + 매일 긴급 손절/익절 체크
...
2. 수요일: 전체 분석 → Claude 배분 결정 → 텔레그램 승인 → KIS API 체결
   그 외: 스킵
```
...
| 장치 | 기준 | 비고 |
|------|------|------|
| 리밸런싱 주기 | 주 1회 수요일 | 긴급 손절/익절은 매일 |
| 손절 | 매수가 대비 -7% | 보유기간 무시, 즉시 매도 |
| 익절 | 매수가 대비 +10% | 3영업일 보유 후 |
| 홀딩 강제 | -7% ~ +10% 구간 | Claude 임의 매도 차단 |
| 최소 보유기간 | 3영업일 | 손절 예외 |
| 회전율 한도 | 총자산 40% | 초과 시 비례 축소 |
| 안정화 기간 | ~2026-04-10 | 대형주 30개만 |
